...
START TRANSACTION;
INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (133, '', 'Mobile apps / read', 0);
INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (134, '', 'Mobile apps / add', 0);
INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (135, '', 'Mobile apps / change', 0);
INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (136, '', 'Mobile apps / delete', 0);
INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (137, '', 'Mobile app versions / read', 0);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260528184056_add_mobile_admin_accesses', '10.0.1');

COMMIT;

START TRANSACTION;
CREATE TABLE "SalaryDocuments" (
    "Id" bigint GENERATED BY DEFAULT AS IDENTITY,
    "CompanyId" bigint NOT NULL,
    "DriverId" bigint NOT NULL,
    ...
    "TotalAdditions" numeric NOT NULL,
    "TotalCommission" numeric NOT NULL,
    "NetAmountDue" numeric NOT NULL,
    "OutstandingDebt" numeric NOT NULL,
    "CashBalance" numeric NOT NULL,
    "PreviousCashBalance" numeric NOT NULL,
    ...
    "Deleted" boolean NOT NULL,
    CONSTRAINT "PK_SalaryDocuments" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SalaryDocuments_Companies_CompanyId" FOREIGN KEY ("CompanyId") REFERENCES "Companies" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_SalaryDocuments_Transactions_PaymentTransactionId" FOREIGN KEY ("PaymentTransactionId") REFERENCES "Transactions" ("Id"),
    CONSTRAINT "FK_SalaryDocuments_Users_DriverId" FOREIGN KEY ("DriverId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);

CREATE TABLE "SalaryDocumentAggregatorRows" (
    "Id" bigint GENERATED BY DEFAULT AS IDENTITY,
    "SalaryDocumentId" bigint NOT NULL,
    "AggregatorName" text,
    "TripsAmount" numeric NOT NULL,
    "CommissionAmount" numeric NOT NULL,
    "BonusAmount" numeric NOT NULL,
    "NetIncome" numeric NOT NULL,
    "SortOrder" integer NOT NULL,
    CONSTRAINT "PK_SalaryDocumentAggregatorRows" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SalaryDocumentAggregatorRows_SalaryDocuments_SalaryDocument~" FOREIGN KEY ("SalaryDocumentId") REFERENCES "SalaryDocuments" ("Id") ON DELETE CASCADE
);

CREATE TABLE "SalaryDocumentCommissionTiers" (
    "Id" bigint GENERATED BY DEFAULT AS IDENTITY,
    "SalaryDocumentId" bigint NOT NULL,
    "FromAmount" numeric NOT NULL,
    "ToAmount" numeric,
    "Percent" numeric NOT NULL,
    "TierBaseAmount" numeric NOT NULL,
    "DriverShareAmount" numeric NOT NULL,
    "SortOrder" integer NOT NULL,
    CONSTRAINT "PK_SalaryDocumentCommissionTiers" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SalaryDocumentCommissionTiers_SalaryDocuments_SalaryDocumen~" FOREIGN KEY ("SalaryDocumentId") REFERENCES "SalaryDocuments" ("Id") ON DELETE CASCADE
);

CREATE TABLE "SalaryDocumentLineItems" (
    "Id" bigint GENERATED BY DEFAULT AS IDENTITY,
    "SalaryDocumentId" bigint NOT NULL,
    ...
    "SortOrder" integer NOT NULL,
    CONSTRAINT "PK_SalaryDocumentLineItems" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SalaryDocumentLineItems_SalaryDocuments_SalaryDocumentId" FOREIGN KEY ("SalaryDocumentId") REFERENCES "SalaryDocuments" ("Id") ON DELETE CASCADE
);

INSERT INTO "TransactionTypes" ("Id", "Description", "IsAggrTransaction", "IsDebtPayment", "IsFine", "Name", "ShortName")
VALUES (47, '', FALSE, FALSE, FALSE, 'Driver allowance', NULL);

CREATE INDEX "IX_SalaryDocumentAggregatorRows_SalaryDocumentId" ON "SalaryDocumentAggregatorRows" ("SalaryDocumentId");

CREATE INDEX "IX_SalaryDocumentCommissionTiers_SalaryDocumentId" ON "SalaryDocumentCommissionTiers" ("SalaryDocumentId");

CREATE INDEX "IX_SalaryDocumentLineItems_SalaryDocumentId" ON "SalaryDocumentLineItems" ("SalaryDocumentId");

CREATE INDEX "IX_SalaryDocuments_CompanyId" ON "SalaryDocuments" ("CompanyId");

CREATE INDEX "IX_SalaryDocuments_DriverId" ON "SalaryDocuments" ("DriverId");

CREATE INDEX "IX_SalaryDocuments_PaymentTransactionId" ON "SalaryDocuments" ("PaymentTransactionId");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260531202808_AddSalaryDocuments', '10.0.1');

COMMIT;

START TRANSACTION;
ALTER TABLE "MobileApps" RENAME COLUMN "ApkDownloadLink" TO "ApkFilePath";

INSERT INTO "AuthAccesses" ("Id", "Description", "Name", "Priority")
VALUES (109, '', 'Salaries / pay', 0);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260601174257_AddMobileAppApkFilePath', '10.0.1');

COMMIT;

START TRANSACTION;
ALTER TABLE "MobileApps" DROP CONSTRAINT "FK_MobileApps_Companies_CompanyId";

DROP INDEX "IX_MobileApps_CompanyId";

ALTER TABLE "MobileApps" DROP COLUMN "CompanyId";

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260601180802_RemoveAppsCompanyId', '10.0.1');
